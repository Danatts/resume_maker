...
export default function Preview() {
  return (
    <div class="bg-gray-200 h-fit rounded justify-self-center">
      <div class="h-[21cm] w-[14.8cm] border border-black shadow-gray-500 shadow-md overflow-y-auto scale-90 bg-white p-10">
        <div id="preview">
          <Basics />
          <Work />
          <Education />
